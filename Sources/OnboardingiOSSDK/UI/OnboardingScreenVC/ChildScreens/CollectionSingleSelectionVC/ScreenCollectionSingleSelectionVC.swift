...
//    @IBOutlet weak var collectionView: UICollectionView!
    ...
    override func runInitialAnimation() {
        ...
        DispatchQueue.main.async {
            OnboardingAnimation.runAnimationOfType(.tableViewCells(style: .fade), in: self.collectionView)
        }
    }
...
extension ScreenCollectionSingleSelectionVC: UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
         ...
         guard let screenData = self.screenData, indexPath.section < allSections().count else {
//              assertionFailure("Attempted to access invalid section in sizeForItemAt")
             return .zero
         }
         ...
         guard indexPath.row < rows.count else {
             // assertionFailure("Attempted to access invalid row in sizeForItemAt")
             return .zero
         }
...
private extension ScreenCollectionSingleSelectionVC {
    func setTopInset() {
        ...
        if contentHeight > collectionHeight || self.media != nil {
